...
- [Complete electron-updater HTTP example](https://gist.github.com/tommyduong23/0ff845e8e3f59dbe7eaf2bf24443f104)
...
**NOTE:** If you want to run through this whole process, you will need to fork this repo on GitHub and replace all instances of `tommyduong23` with your GitHub username before doing the following steps.
